...
const articles = [
    {
        ...
        tag: "SYSTEMS DESIGN",
        date: "2025-03-10",
        href: "https://techieemma.medium.com/building-a-scalable-backend-in-go-using-microservices-%EF%B8%8F-bddb3a2d227b?sharedUserId=techieemma",
        live: true,
    },
    {
        num: "02",
        ...
        date: "2026-06-23",
        href: "https://medium.com/@techieemma/i-built-a-distributed-secrets-platform-from-scratch-the-hardest-part-wasnt-the-code-013201984421?sharedUserId=techieemma",
        live: true,
    },
    {
        num: "03",
        title: "Build a Real URL Shortener in Go — From One File to Microservices to Serverless",
        tag: "SYSTEMS DESIGN",
        date: "2026-06-25",
        href: "https://medium.com/@techieemma/build-a-real-url-shortener-in-go-from-one-file-to-microservices-to-serverless-88749eda9d01?sharedUserId=techieemma",
        live: true,
    },
    {
        num: "04",
        title: "VEYRONIX: Building an Internal Platform From First Principles",
